...
var block1Origin = [0, 6]; // origin of the circle/red block
var block2Origin = [1, 6]; // origin of the x/blue block
var block3Origin = [0, 5]; // origin of the square/yellow block
